...
public class PizzaOrder {
	...
	int pricePerBox = returnPrice(pizzaCategory);
	int slicesPerBox = numberOfSlices(pizzaCategory);
	

	int boxesNeeded = PizzaFunction.numberOfPizzaBoxes(guestNumber, numberOfSlices);
	System.out.println("Number of boxes of Pizza to buy: " + boxesNeeded);

	int leftOverSlices = PizzaFunction.leftOver(boxesNeeded, numberOfSlices, guestNumber);
